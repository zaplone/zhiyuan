    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="bg-slate-50 border-b border-slate-200">
        <div className="container mx-auto px-4 py-3">
          <nav className="flex items-center text-sm text-slate-500">
            ...
            <Link href={`/${locale}/products`} className="hover:text-slate-800 transition-colors">{tNav('products')}</Link>
            <ChevronRight className="w-3.5 h-3.5 mx-1.5 text-slate-300" />
            <span className="text-slate-800 font-medium truncate max-w-[180px] sm:max-w-sm">{p.name}</span>
          </nav>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row gap-0 lg:gap-12 xl:gap-16">
          ...
          ════════════════════════════════════════ */}
          <div className="w-full lg:w-[52%] lg:sticky lg:top-20 lg:self-start lg:h-[calc(100vh-80px)] lg:overflow-y-auto pb-10 pt-8">
              ...
              <div className="flex gap-2 mt-3 overflow-x-auto pb-1 scrollbar-hide">
                ...
                {hasVideo && (
                  ...
                  >
                    ...
                    <span className="text-xs mt-0.5 font-medium">Video</span>
                  </button>
                )}
              </div>
            )}
            ...
            <div className="mt-5 grid grid-cols-4 gap-2">
              {[
                ...
                { label: 'EN ISO', sub: '20345' },
                { label: 'SGS', sub: 'Tested' },
              ].map((c) => (
              ...
              {product.spec_pdf_url ? (
                ...
                >
                  ...
                  <span className="text-[10px] text-blue-700 font-medium leading-none">Spec PDF</span>
                </a>
              ) : (
                <div className="flex flex-col items-center justify-center bg-slate-50 border border-dashed border-slate-200 rounded-xl py-2.5 px-1 text-center opacity-50">
                  ...
                  <span className="text-[10px] text-slate-400 leading-none">Spec PDF</span>
                </div>
              )}
            </div>
            ...
            <div className="mt-4 p-4 bg-slate-50 rounded-xl border border-slate-100">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-xs font-medium text-slate-500 uppercase tracking-wide">Trusted by buyers in 50+ countries</span>
              </div>
              <div className="flex items-center gap-2 flex-wrap">
                {/* Country flags / region chips */}
                {['🇩🇪 EU', '🇸🇦 Middle East', '🇻🇳 SE Asia', '🇧🇷 Latin America'].map((r) => (
          ...
          ════════════════════════════════════════ */}
          <div className="w-full lg:w-[48%] flex flex-col divide-y divide-slate-100 pt-8 pb-24">
            ...
            <section className="pb-6">
              ...
              {/* Value proposition line — replaces the generic certTagline */}
              <p className="text-sm text-slate-600 mb-3 leading-relaxed">
                Factory-direct · CE marked · EN ISO 20345 certified · OEM &amp; private label available
              </p>

              {product.model_code && (
                <div className="inline-flex items-center gap-2 text-sm text-slate-500 font-mono bg-slate-100 px-3 py-1 rounded-lg">
                  <span className="text-xs font-bold text-slate-600 non-mono">MODEL</span>
                  {product.model_code}
                </div>
              )}
            </section>

            {/* ── 02 TRUST STATS — moved up right below hero ── */}
            ...
            <section className="py-6">
              <h2 className="text-base font-bold text-slate-900 mb-3 uppercase tracking-widest text-xs text-slate-400">
            ...
            <section className="py-6">
              ...
              <div className="bg-slate-900 text-white rounded-2xl p-5">
                ...
                {product.spec_pdf_url && (
                  ...
                  >
                    <Download className="w-3.5 h-3.5" />
                    Download Certificate / Test Report
                  </a>
                )}
              </div>
            </section>
            ...
            <section className="py-6">
              <h2 className="text-sm font-bold text-slate-900 uppercase tracking-widest mb-4">Trusted Globally</h2>
              <div className="rounded-2xl border border-slate-100 p-5 bg-slate-50/50">
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="w-4 h-4 text-slate-400" />
                  <span className="text-sm text-slate-600 font-medium">Shipped to 50+ countries across 5 continents</span>
                </div>
                {/* Region tags */}
                <div className="flex flex-wrap gap-2 mb-5">
                  {[
                    { flag: '🇩🇪', label: 'EU Market' },
                    { flag: '🇸🇦', label: 'Middle East' },
                    { flag: '🇺🇸', label: 'North America' },
                    { flag: '🇻🇳', label: 'SE Asia' },
                    { flag: '🇧🇷', label: 'Latin America' },
                    { flag: '🌍', label: 'Africa' },
                  ].map(({ flag, label }) => (
                ...
                <div className="bg-white rounded-xl border border-slate-100 p-4">
                  <p className="text-sm text-slate-700 leading-relaxed italic mb-3">
                    "Quality consistent with samples, CE documents delivered on time. We've been ordering for 3 years."
                  </p>
                  <div className="flex items-center gap-2">
                    <div className="w-7 h-7 rounded-full bg-slate-200 flex items-center justify-center text-xs font-bold text-slate-600">AB</div>
                    <div>
                      <span className="text-xs font-medium text-slate-900">A. Becker</span>
                      <span className="text-xs text-slate-400 ml-1.5">· PPE Distributor, Germany</span>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    try {
                      ...
                      return (
                        <div key={ind} className="p-4 rounded-xl border border-slate-200 bg-white">
                          ...
                          <p className="text-xs text-slate-500 mb-1"><span className="font-medium text-slate-600">Challenge: </span>{pain}</p>
                          <p className="text-xs text-slate-700"><span className="font-medium text-slate-600">Solution: </span>{solution}</p>
                        </div>
                      );
                    } catch { return null; }
                  })}
                ...
                <div className="grid grid-cols-2 gap-3 pt-4 border-t border-blue-100">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <div className="text-sm font-bold text-slate-900">500 pairs</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <div className="text-sm font-bold text-slate-900">30–45 days</div>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="500-999">500 – 999 pairs</option>
                        <option value="1000-2999">1,000 – 2,999 pairs</option>
                        <option value="3000-9999">3,000 – 9,999 pairs</option>
      ...
      >
        <div className="bg-white border-t border-slate-200 px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-slate-500">Factory direct · CE certified</p>
          </div>
          <button
